...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Welcome to Hospital Main : <span class="style3"><%=application.getAttribute("ow")%></span></h2>
		  
		  
		  
		  <p align="center"><img src="images/Owner.jpg" width="433" height="240" /></p>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
